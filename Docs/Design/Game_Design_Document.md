...
- **Estética Visual (3D):** Isométrico 3D estilo "Maqueta de Juguete" (Toy-box / Claymation). Los personajes y muebles son modelos 3D con **dirección de mirada**. Es muy amigable, hiper-colorido y táctil, ideal para atraer tanto a niños como a adultos. Permite variaciones estacionales (nieve para Navidad).
